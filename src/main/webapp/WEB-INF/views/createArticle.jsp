...
<head>
    ...
    div#createArticle { width:700px; margin:auto;  }
	</style>
</head>
<body>
...
<div id="createArticle">
  <h3>글 OO(글id값을 참조고 작성인지 수정인지 출력)</h3>
  <hr>

<form id="createArticle">

  <input type="text" class="form-control" placeholder="글 제목"><br>
  <textarea class="form-control" rows="15" placeholder="내용"></textarea><br>
